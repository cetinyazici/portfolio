    ...
    public partial class migration_init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Chooseuss", x => x.ChooseusId);
                });
            ...
            migrationBuilder.CreateTable(
                name: "PortfolioDetailss",
                columns: table => new
                {
                    PortfolioDetailsId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PortfolioDetailss", x => x.PortfolioDetailsId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Portfolios", x => x.GalleryId);
                });
